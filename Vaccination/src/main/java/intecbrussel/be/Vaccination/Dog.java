...
//zorgt ervoor dat een animal clean gemaakt wordt. Indien je aan het werken bent met een
...
//Deze method zal een dier vaccineren voor een bepaalde ziekte. Zet er de boolean
//dus voor op true
    @Override
